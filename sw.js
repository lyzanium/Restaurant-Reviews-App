/**
 *  This is service worker script that takes care of loading data from cache, especially helpful when loading page offline
 */

var CACHE_NAME = 'my-site-cache-v1'
/**
 *  when the page is loading for the first time tell the app what urls we want content from to save so it can be used next time
 */
var urlsToCache = [
  '/',
  '/restaurant.html',
